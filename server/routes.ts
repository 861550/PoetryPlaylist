...
async function seedDatabase() {
  ...
  const songsData = [
    ...
    { title: "Gangsta's Paradise", artist: "Coolio", album: "Gangsta's Paradise", duration: "4:17", coverUrl: "https://images.unsplash.com/photo-1514525253440-b393452e8d03?q=80&w=200&auto=format&fit=crop", meaning: "A profound reflection on the struggles and reality of life in the inner city. It explores themes of survival, mortality, and the cycle of violence, set against a hauntingly beautiful melody." },
    { title: "Double Life", artist: "Pharrell Williams", album: "Despicable Me 4", duration: "3:13", coverUrl: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&w=200&auto=format&fit=crop", meaning: "Explores the complexity of maintaining different identities or secrets. It's an upbeat yet thought-provoking track about the hidden layers of our lives." },
    { title: "Chicago Freestyle", artist: "Drake & Giveon", album: "Dark Lane Demo Tapes", duration: "3:42", coverUrl: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?q=80&w=200&auto=format&fit=crop", meaning: "A moody, late-night reflection on fame, relationships, and the isolation that often comes with success. Giveon's soulful vocals add a layer of melancholy to Drake's introspective verses." },
    { title: "Thriller", artist: "Michael Jackson", album: "Thriller", duration: "5:58", coverUrl: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=200&auto=format&fit=crop", meaning: "The ultimate cinematic pop experience, using horror themes to explore the excitement and fear of the unknown. It's a masterpiece of storytelling and production." },
    { title: "Bad to the Bone", artist: "George Thorogood & The Destroyers", album: "Bad to the Bone", duration: "4:51", coverUrl: "https://images.unsplash.com/photo-1487180144351-b8472da7d491?q=80&w=200&auto=format&fit=crop", meaning: "A classic rock anthem about confidence and a rebellious spirit. The driving riff and gritty vocals capture a raw, unapologetic energy." },
